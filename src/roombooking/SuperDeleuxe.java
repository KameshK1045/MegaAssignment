...
public class SuperDeleuxe implements RoomBooking{
...
public void bookAndLetKnows() {
      System.out.println("Booked Successfully, food all time available, room service provided, coffee,Tea free charge");
}
}
